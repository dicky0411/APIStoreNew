    ...
    <div class="container mt-5">
        ...
        <form id="CurexForm" class="mt-4" wire:submit.prevent="search">
            <div class="form-group">
                ...
                <input type="text" class="form-control" wire:model:defer="currency" id="currencyType" placeholder="CAD" required>
                <br>
                <label for="amount">How many of this currency do you want to exchange?</label>
                <input type="text" class="form-control" wire:model:defer="amount" id="currencyamount" placeholder="100" required>
            </div>
